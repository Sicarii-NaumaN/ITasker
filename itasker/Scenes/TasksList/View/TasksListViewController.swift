...
class TasksListViewControler: UIViewController, UITextViewDelegate, UITableViewDelegate {
    
    var presenter: TasksListPresenter

  
    private var myButton = UIButtonTextIcon(image: "", text: "+ ДОБАВИТЬ ЗАДАЧУ", colorForButton: .black, colorForIcon: .white)
    ...
    let settingButton = UIButtonTextIcon(image: "rectange", text: nil, colorForButton: .white, colorForIcon: .black)
    ...
    override func viewDidLoad() {
        ...
        myHeader.text = "Все задачи"
        myHeader.textAlignment = .center
