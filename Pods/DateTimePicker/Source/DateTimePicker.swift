...
@objc public class DateTimePicker: UIView {
    ...
    public var darkColor = UIColor(red: 0, green: 22.0/255.0, blue: 39.0/255.0, alpha: 1) {
        didSet {
            ...
            borderBottomView.backgroundColor = .systemOrange
            separatorTopView.backgroundColor = .systemOrange
    ...
    /// custom background color for titles
    public var titleBackgroundColor = UIColor.white /* UIColor(red: 239.0/255.0, green: 243.0/255.0, blue: 244.0/255.0, alpha: 1)*/ {
        didSet {
            configureView()
        }
    }
    ...
    public var daysBackgroundColor = UIColor.systemOrange.withAlphaComponent(0.2) {
    ...
    public var cancelButtonTitle = "Отменить" {
        didSet {
    ...
    public var todayButtonTitle = "Сегодня" {
        didSet {
...
//    }
    ...
    private func configureView() {
        ...
        borderTopView.backgroundColor = .systemOrange.withAlphaComponent(0.2)
        borderBottomView.backgroundColor = .systemOrange.withAlphaComponent(0.2)
